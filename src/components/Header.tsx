    ...
    <header className={`${theme === 'dark' ? 'bg-[rgba(13,13,20,0.85)]' : 'bg-[rgba(255,255,255,0.85)]'} border-b backdrop-blur-xl h-[72px] transition-all duration-250 shadow-lg ${
      ...
      <div className="h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-white shadow-sm group-hover:scale-105 group-hover:shadow-md transition-all duration-250 overflow-hidden">
