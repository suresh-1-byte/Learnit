  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in">
      ...
      <div className="bg-gradient-to-br from-[#1E1B4B] via-[#111838] to-[#0B0F28] p-8 sm:p-10 text-center">
        ...
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white">Student Portal</h1>
        <p className="text-[10px] sm:text-xs text-[#AAA] mt-1 sm:mt-2">Student Access • Learning & Career</p>
      </div>
